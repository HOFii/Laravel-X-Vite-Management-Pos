...
$__html = app('livewire')->mount($__name, $__params, 'Ct0BLlP', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'R3BzkpJ', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'fJak9fU', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HOFi Desuka\triangle-pos\Modules/Sale\Resources/views/pos/index.blade.php ENDPATH**/ ?>